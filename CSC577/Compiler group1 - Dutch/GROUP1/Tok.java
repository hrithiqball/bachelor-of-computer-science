...
class Tok {
    ...
    Tok(Lexer lxr) { lexer = lxr; }

    void getToken() {
        try { 
            t = lexer.next(); 
            while (t instanceof TSpace || t instanceof TComment1 || t instanceof TComment2)
                t = lexer.next(); 
    ...
    public int getLine() { return ((Token)t).getLine(); }

    public int getPos() { return ((Token)t).getPos(); }
